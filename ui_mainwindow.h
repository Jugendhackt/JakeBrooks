...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        answer1 = new QRadioButton(foreGround);
        ...
        answer2 = new QRadioButton(foreGround);
        ...
        answer3 = new QRadioButton(foreGround);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        answer1->setText(QString());
        answer2->setText(QString());
        answer3->setText(QString());
